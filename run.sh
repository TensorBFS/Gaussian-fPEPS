...
CUDA_VISIBLE_DEVICES=$CUDA /home/qiyang/bin/python /home/qiyang/source/jaxgfpeps/src/main.py --Mu 0.5 --Lx 101 --Ly 101  --DeltaX 0.0 --DeltaY 0.0 --label $seed  --loadlabel $seed --seed $seed --Nv $Nv --MaxIter 1000
