...
# TEMP:
    Nv = args.Nv
    Rsize = 8*Nv+4
    LoadKey = "/home/qiyang/source/jaxgfpeps/data/Nv{}C{}.h5".format(args.Nv,args.loadlabel)
    Key = "/home/qiyang/source/jaxgfpeps/data/Nv{}C{}.h5".format(args.Nv,args.label)
#
